...
Removes a VM from vSphere, keeping data disks by default. Default mode is 'dry-run' true.
Available options:
-h, --help             Print this help and exit
-v, --verbose          Print script debug info
-a, --apply            Apply removal as described in the dry-run, default is false
-d, --delete-data      Delete the VM but keep additional disks that were added, default is false
